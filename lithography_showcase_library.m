...
presets(end + 1) = struct( ...
    ...
    'description', 'A simple textbook circular source case. Useful to check that the pupil stays disk-like and the image remains rotationally symmetric.', ...
    'params', p);
...
presets(end + 1) = struct( ...
    ...
    'description', 'Classic off-axis annular illumination for dense lines. The pupil should show a ring and the detector should keep strong line contrast.', ...
    'params', p);
